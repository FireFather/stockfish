...
# endif
	...
	public:
		...
		*/
		static IndexType get_weight_index(const IndexType i)
		{
...
#define vec_haddx4 Simd::neon_m128_haddx4
			...
			const auto invec = reinterpret_cast<const in_vec_t*>(input);
			...
			for (IndexType bigBlock = 0; bigBlock < NumBigBlocks; ++bigBlock)
			{
				...
				{
					const auto outputvec = reinterpret_cast<bias_vec_t*>(output);
					const auto biasvec = reinterpret_cast<const bias_vec_t*>(biases);
...
# undef vec_haddx4
	...
	public:
		...
		static IndexType get_weight_index_scrambled(const IndexType i)
		{
			return
...
#define vec_haddx4 Simd::m128_haddx4
			...
			if constexpr (OutputDimensions % OutputSimdWidth == 0)
			{
				...
				const auto outptr = reinterpret_cast<vec_t*>(output);
				for (IndexType k = 0; k < NumRegs; ++k)
					outptr[k] = acc[k];
			}
