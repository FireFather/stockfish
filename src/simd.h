...
# endif
	...
	[[maybe_unused]] static int m256_hadd(const __m256i sum, const int bias) {
	...
	[[maybe_unused]] static __m128i m256_haddx4(
		__m256i sum0, const __m256i sum1, __m256i sum2, const __m256i sum3,
		const __m128i bias) {
...
# endif
	...
	[[maybe_unused]] static void m256_add_dpbusd_epi32x2(
		__m256i& acc,
		const __m256i a0, const __m256i b0,
		const __m256i a1, const __m256i b1) {
...
#   else
		...
		const __m256i product1 = _mm256_maddubs_epi16(a1, b1);
...
# endif
	...
	[[maybe_unused]] static int m128_hadd(__m128i sum, const int bias) {
	...
	[[maybe_unused]] static __m128i m128_haddx4(
		__m128i sum0, const __m128i sum1, __m128i sum2, const __m128i sum3,
		const __m128i bias) {
...
#   endif
	...
	[[maybe_unused]] static void m128_add_dpbusd_epi32x2(
		__m128i& acc,
		const __m128i a0, const __m128i b0,
...
#   else
		...
		const __m128i product1 = _mm_maddubs_epi16(a1, b1);
